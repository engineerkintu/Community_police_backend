...
<head>
  ...
  <body>
    <p>Hello <span> <b>{{ $userto->first_name }}</b> </span></p>
      <p>{{ $userfrom->first_name . ' ' . $userfrom->last_name }} would like to chat with you on Chaguzi App</p>
      <p><b>You may accept to chat by clicking on the Chat tab and selecting the Chat Requests </b></p>
